...
export const lastGaspTheme = EditorView.theme({
  ...
  '&.cm-focused .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection': { backgroundColor: 'rgba(201, 168, 96, 0.2)' },
...
export const lastGaspHighlightStyle = HighlightStyle.define([
  ...
  { tag: [t.name, t.deleted, t.character, t.propertyName, t.macroName], color: 'var(--theme-text-primary)' },
  ...
  { tag: [t.typeName, t.className, t.number, t.changed, t.annotation, t.modifier, t.self, t.namespace], color: 'var(--theme-accent-gold)' },
  { tag: [t.operator, t.operatorKeyword, t.url, t.escape, t.regexp, t.link, t.special(t.string)], color: 'var(--theme-link)' },
